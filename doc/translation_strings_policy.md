...
This document provides guidelines for internationalization of the OHONETWORK Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to OHONETWORK network</source>
        <translation>
            <numerusform>%n active connection to OHONETWORK network</numerusform>
            <numerusform>%n active connections to OHONETWORK network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ohonetwork_en.ts` remains unchanged.
