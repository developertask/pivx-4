...
The build script we'll be using is contained in the OHONETWORK github repository ([contrib/gitian-build.py](https://github.com/ohonetwork-project/ohonetwork/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the OHONETWORK repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/OHONETWORK-Project/OHONETWORK/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, ohonetwork-detached-sigs, and ohonetwork GitHub repos.
