...
namespace AddressBook {
    ...
    namespace AddressBookPurpose {
        ...
        const std::string COLD_STAKING{"litenodestaking"};
        const std::string COLD_STAKING_SEND{"litenodestaking_send"};
    }

    bool IsLiteNodeStakingPurpose(const std::string& purpose) {
        return purpose == AddressBookPurpose::COLD_STAKING
               || purpose == AddressBookPurpose::COLD_STAKING_SEND;
    }

    bool CAddressBookData::isSendLiteNodeStakingPurpose() const {
