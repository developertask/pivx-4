 ...
 * OHONETWORK system. There are three: the main network on which people trade goods
...
public:
    ...
    CAmount GetMinLiteNodeStakingAmount() const { return nMinLiteNodeStakingAmount; }
    ...
    int OhonetworkBadBlockTime() const { return nOhonetworkBadBlockTime; }
    int OhonetworkBadBlocknBits() const { return nOhonetworkBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nOhonetworkBadBlockTime;
    unsigned int nOhonetworkBadBlocknBits;
    ...
    CAmount nMinLiteNodeStakingAmount;
