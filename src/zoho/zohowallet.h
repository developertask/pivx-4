// Copyright (c) 2017-2018 The OHONETWORK developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef OHONETWORK_ZOHOWALLET_H
#define OHONETWORK_ZOHOWALLET_H
...
public:
    CzOHOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZOHO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZOHO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
