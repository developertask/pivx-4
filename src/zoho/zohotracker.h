...
#ifndef OHONETWORK_ZOHOTRACKER_H
#define OHONETWORK_ZOHOTRACKER_H
...
public:
    CzOHOTracker(std::string strWalletFile);
    ~CzOHOTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzOHOWallet* zOHOWallet = NULL);
...
#endif //OHONETWORK_ZOHOTRACKER_H
