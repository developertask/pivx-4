                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzOHOPathCustom = GetArg("-zohobackuppath", "");
    ...
    if(!strzOHOPathCustom.empty()) {
        ui->wallet_customzohobackuppath->setText(QString::fromStdString(strzOHOPathCustom));
        ui->wallet_customzohobackuppath_label->setVisible(true);
        ui->wallet_customzohobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzOHOPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the OHONETWORK RPC console.") + "<br>" +
