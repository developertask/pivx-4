...
/** Interface from Qt to configuration data structure for OHONETWORK client.
...
public:
    ...
    enum OptionID {
        ...
        HideOrphans,    // bool
        AnonymizeOhonetworkAmount, //int
        ShowMasternodesTab,  // bool
        Listen,              // bool
        StakeSplitThreshold, // int
        ShowLiteNodeStakingScreen, // bool
        OptionIDRowCount,
    };
    ...
    bool isLiteNodeStakingScreenEnabled() { return showLiteNodeStakingScreen; }
    bool invertLiteNodeStakingScreenStatus() {
        setData(
                createIndex(ShowLiteNodeStakingScreen, 0),
                !isLiteNodeStakingScreenEnabled(),
                Qt::EditRole
        );
...
private:
    ...
    bool showLiteNodeStakingScreen;
...
signals:
    ...
    void anonymizeOhonetworkAmountChanged(int);
    void coinControlFeaturesChanged(bool);
    void showHideLiteNodeStakingScreen(bool);
