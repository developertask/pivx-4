...
// Copyright (c) 2016-2020 The OHONETWORK developers
...
public:
    ...
    static bool HasZcTxesIfNeeded(const TransactionRecord& record) {
        return (record.type == TransactionRecord::ZerocoinMint ||
                ...
                record.type == TransactionRecord::ZerocoinSpend_Change_zOho ||
...
void TransactionTableModel::updateTransaction(const QString& hash, int status, bool showTransaction)
{
    ...
    if (!rec.isNull())
        emit txArrived(hash, rec.isCoinStake(), rec.isAnyLiteNodeStakingType());
}
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeZOHO:
        return tr("zOHO Stake");
    case TransactionRecord::StakeDelegated:
        return tr("OHO Cold Stake");
    case TransactionRecord::StakeHot:
        return tr("OHO Stake on behalf of");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted OHO to zOHO");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zOHO");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received OHO from zOHO");
    case TransactionRecord::ZerocoinSpend_Change_zOho:
        return tr("Minted Change as zOHO from zOHO Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zOHO to OHO");
    default:
        return QString();
    }
}
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        if (rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeMint ||
                rec->type == TransactionRecord::StakeZOHO || rec->type == TransactionRecord::MNReward) {
