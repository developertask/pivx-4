...
public:
    ...
    static const QString LiteNodeStaking; /**< Specifies cold staking own addresses */
    static const QString LiteNodeStakingSend; /**< Specifies send cold staking addresses (simil 'contacts')*/
