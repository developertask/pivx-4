...
/** Utility functions used by the OHONETWORK Qt UI.
 */
namespace GUIUtil
{
...
// Render OHONETWORK addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZoho = false);
...
// Parse "ohonetwork:" URI into recipient object, return true on successful parsing
