...
#ifndef OHONETWORK_QT_WALLETMODEL_H
#define OHONETWORK_QT_WALLETMODEL_H
...
/** Interface to OHONETWORK wallet from Qt view code. */
...
public:
    ...
    bool isLiteNodeStakingNetworkelyEnabled() const;
    CAmount getMinLiteNodeStakingAmount() const;
    ...
    bool whitelistAddressFromLiteNodeStaking(const QString &addressStr);
    bool blacklistAddressFromLiteNodeStaking(const QString &address);
...
#endif // OHONETWORK_QT_WALLETMODEL_H
