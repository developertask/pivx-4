...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("fShowLiteNodeStakingScreen"))
        settings.setValue("fShowLiteNodeStakingScreen", false);
    showLiteNodeStakingScreen = settings.value("fShowLiteNodeStakingScreen", false).toBool();
...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset){
    if (!settings.contains("nDisplayUnit") || reset)
        settings.setValue("nDisplayUnit", BitcoinUnits::OHO);
    ...
    if (settings.contains("nAnonymizeOhonetworkAmount") || reset)
        SoftSetArg("-anonymizeohonetworkamount", settings.value("nAnonymizeOhonetworkAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in ohonetwork.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case ShowLiteNodeStakingScreen:
            return showLiteNodeStakingScreen;
        case DatabaseCache:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case CoinControlFeatures:
            ...
            break;
        case ShowLiteNodeStakingScreen:
            this->showLiteNodeStakingScreen = value.toBool();
            settings.setValue("fShowLiteNodeStakingScreen", this->showLiteNodeStakingScreen);
            emit showHideLiteNodeStakingScreen(this->showLiteNodeStakingScreen);
            break;
        case DatabaseCache:
