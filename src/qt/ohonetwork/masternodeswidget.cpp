...
#include "qt/ohonetwork/forms/ui_masternodeswidget.h"
#include "qt/ohonetwork/qtutils.h"
#include "qt/ohonetwork/mnrow.h"
#include "qt/ohonetwork/mninfodialog.h"

#include "qt/ohonetwork/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(OHONETWORKGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (COIN * 10000)){
            inform(tr("Not enough balance to create a masternode, 10,000 OHO required."));
            return;
        }
        showHideOp(true);
