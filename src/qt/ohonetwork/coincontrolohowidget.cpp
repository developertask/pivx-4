...
#include "qt/ohonetwork/coincontrolohowidget.h"
#include "qt/ohonetwork/forms/ui_coincontrolohowidget.h"

CoinControlOhoWidget::CoinControlOhoWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlOhoWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select OHO Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("OHO");
    ...
    ui->labelValueAfter->setText("0.00 OHO");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 OHO");
    ui->labelValueFee->setText("0.00 OHO");
...
CoinControlOhoWidget::~CoinControlOhoWidget()
{
    delete ui;
}
