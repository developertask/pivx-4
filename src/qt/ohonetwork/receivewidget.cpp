...
#include "qt/ohonetwork/forms/ui_receivewidget.h"
...
ReceiveWidget::ReceiveWidget(OHONETWORKGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive OHO."));
