...
#include <QWidget>
#include <QString>
#include "qt/ohonetwork/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(OHONETWORKGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    OHONETWORKGUI* getWindow() { return this->window; }
