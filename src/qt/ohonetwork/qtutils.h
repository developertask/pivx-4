...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, OHONETWORKGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, OHONETWORKGUI *gui, double posX = 3);
