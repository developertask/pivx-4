...
#include "qt/ohonetwork/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(OHONETWORKGUI* parent);
    ~SendWidget();
...
private slots:
    void onOHOSelected(bool _isOHO);
    void onSendClicked();
...
private:
    ...
    bool sendZoho(QList<SendCoinsRecipient> recipients);
