...
#include "config/ohonetwork-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalOho = 0;
    qint64 totalZoho = 0;
    QList<qreal> valuesOho;
    QList<qreal> valueszOho;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(OHONETWORKGUI* _window);
    ~DashboardWidget();
