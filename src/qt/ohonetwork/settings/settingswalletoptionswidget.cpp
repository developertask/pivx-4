...
#include "qt/ohonetwork/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/ohonetwork/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(OHONETWORKGUI* _window, QWidget *parent) :
