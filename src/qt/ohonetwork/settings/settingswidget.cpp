...
#include "qt/ohonetwork/settings/forms/ui_settingswidget.h"
#include "qt/ohonetwork/settings/settingsbackupwallet.h"
#include "qt/ohonetwork/settings/settingsbittoolwidget.h"
#include "qt/ohonetwork/settings/settingswalletrepairwidget.h"
#include "qt/ohonetwork/settings/settingswalletoptionswidget.h"
#include "qt/ohonetwork/settings/settingsmainoptionswidget.h"
#include "qt/ohonetwork/settings/settingsdisplayoptionswidget.h"
#include "qt/ohonetwork/settings/settingsmultisendwidget.h"
#include "qt/ohonetwork/settings/settingsinformationwidget.h"
#include "qt/ohonetwork/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(OHONETWORKGUI* parent) :
    PWidget(parent),
