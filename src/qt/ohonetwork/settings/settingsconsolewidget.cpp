...
#include "qt/ohonetwork/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ohonetwork/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(OHONETWORKGUI* _window, QWidget *parent) :
