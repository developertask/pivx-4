...
#include "qt/ohonetwork/settings/settingsnetworkwidget.h"
#include "qt/ohonetwork/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ohonetwork/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(OHONETWORKGUI* _window, QWidget *parent) :
