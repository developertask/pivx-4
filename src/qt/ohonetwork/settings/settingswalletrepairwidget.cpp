...
#include "qt/ohonetwork/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ohonetwork/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(OHONETWORKGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to OHONETWORKGUI::handleRestart()
