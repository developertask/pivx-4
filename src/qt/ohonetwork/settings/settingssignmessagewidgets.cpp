...
#include "qt/ohonetwork/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(OHONETWORKGUI* _window, QWidget *parent) :
