...
#ifndef OHONETWORK_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define OHONETWORK_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //OHONETWORK_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
