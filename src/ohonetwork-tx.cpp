...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ohonetwork Core ohonetwork-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ohonetwork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ohonetwork transaction") + "\n" +
                               "  ohonetwork-tx [options] -create [commands]   " + _("Create hex-encoded ohonetwork transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ohonetwork transaction
