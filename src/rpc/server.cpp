...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop OHONETWORK server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "OHONETWORK server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OHONETWORK features */
        {"ohonetwork", "listmasternodes", &listmasternodes, true, true, false},
        {"ohonetwork", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ohonetwork", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ohonetwork", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ohonetwork", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ohonetwork", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ohonetwork", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ohonetwork", "masternodedebug", &masternodedebug, true, true, false},
        {"ohonetwork", "startmasternode", &startmasternode, true, true, false},
        {"ohonetwork", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ohonetwork", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ohonetwork", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ohonetwork", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ohonetwork", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ohonetwork", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ohonetwork", "preparebudget", &preparebudget, true, true, false},
        {"ohonetwork", "submitbudget", &submitbudget, true, true, false},
        {"ohonetwork", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ohonetwork", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ohonetwork", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ohonetwork", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ohonetwork", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ohonetwork", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ohonetwork", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ohonetwork", "checkbudgets", &checkbudgets, true, true, false},
        {"ohonetwork", "mnsync", &mnsync, true, true, false},
        {"ohonetwork", "spork", &spork, true, true, false},
        {"ohonetwork", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"wallet", "getlitenodestakingbalance", &getlitenodestakingbalance, false, false, true},
        ...
        {"zerocoin", "getzohoseed", &getzohoseed, false, false, true},
        {"zerocoin", "setzohoseed", &setzohoseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzoho", &searchdzoho, false, false, true},
        {"zerocoin", "dzohostate", &dzohostate, false, false, true},
...
{
    return "> ohonetwork-cli " + methodname + " " + args + "\n";
}
