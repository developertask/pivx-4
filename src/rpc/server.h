...
/**
 * OHONETWORK RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZohoSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue getlitenodestakingbalance(const UniValue& params, bool fHelp);
...
extern UniValue setzohoseed(const UniValue& params, bool fHelp);
extern UniValue getzohoseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzoho(const UniValue& params, bool fHelp);
extern UniValue dzohostate(const UniValue& params, bool fHelp);
