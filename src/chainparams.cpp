...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51472;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // OHONETWORK starting difficulty is 1 / 2^12
        ...
        nMinLiteNodeStakingAmount = 1 * COIN;

        /** Height or Time Based Activations **/
        nLastPOWBlock = 259200;
        nOhonetworkBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nOhonetworkBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "ohonetwork.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "ohonetwork.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("warrows.dev", "dnsseed.ohonetwork.warrows.dev"));    // Primery DNS Seeder from warrows
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zoho to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nOhonetworkBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nOhonetworkBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "ohonetwork-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "ohonetwork-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.ohonetwork.warrows.dev"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet ohonetwork addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet ohonetwork script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet ohonetwork BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet ohonetwork BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet ohonetwork BIP44 coin type is '1' (All coin's testnet default)
