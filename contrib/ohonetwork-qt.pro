...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/ohonetwork-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/ohonetwork-cli.cpp \
           src/ohonetwork-tx.cpp \
           src/ohonetwork.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/ohonetwork.qrc src/qt/ohonetwork_locale.qrc

TRANSLATIONS += src/qt/locale/ohonetwork_bg.ts \
                src/qt/locale/ohonetwork_de.ts \
                src/qt/locale/ohonetwork_en.ts \
                src/qt/locale/ohonetwork_es.ts \
                src/qt/locale/ohonetwork_fi.ts \
                src/qt/locale/ohonetwork_fr.ts \
                src/qt/locale/ohonetwork_it.ts \
                src/qt/locale/ohonetwork_ja.ts \
                src/qt/locale/ohonetwork_pl.ts \
                src/qt/locale/ohonetwork_pt.ts \
                src/qt/locale/ohonetwork_ru.ts \
                src/qt/locale/ohonetwork_sk.ts \
                src/qt/locale/ohonetwork_sv.ts \
                src/qt/locale/ohonetwork_vi.ts \
                src/qt/locale/ohonetwork_zh_CN.ts \
                src/qt/locale/ohonetwork_zh_TW.ts
