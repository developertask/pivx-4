...
from test_framework.ohonetwork_node import OhonetworkTestNode
...
class OHONETWORK_LiteNodeStakingTest(OhonetworkTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(OhonetworkTestNode())
    ...
    def setLiteNodeStakingEnforcement(self, fEnable=True):
    ...
    def isLiteNodeStakingEnforced(self):
        # verify from node[1]
    ...
    def run_test(self):
        ...
        assert (not self.isLiteNodeStakingEnforced())
        print("*** 1 ***")
        ...
        # Enable SPORK
        self.setLiteNodeStakingEnforcement()
        # double check
        assert (self.isLiteNodeStakingEnforced())
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 OHO from the pot)
        ...
        self.setLiteNodeStakingEnforcement(False)
        assert (not self.isLiteNodeStakingEnforced())
...
if __name__ == '__main__':
    OHONETWORK_LiteNodeStakingTest().main()
