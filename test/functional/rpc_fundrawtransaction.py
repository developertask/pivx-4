...
class RawTransactionsTest(OhonetworkTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid ohonetwork address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid ohonetwork address" in e.error['message'])
