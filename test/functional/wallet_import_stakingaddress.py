#!/usr/bin/env python3
# Copyright (c) 2020 The OHONETWORK developers
...
class ImportStakingTest(OhonetworkTestFramework):
    ...
    def run_test(self):
        ...
        for i, sa in enumerate(staking_addresses):
            ...
            assert_equal(self.nodes[0].getlitenodestakingbalance(), DecimalAmt(10 * (i+1)))
        ...
        assert_equal(self.nodes[1].getlitenodestakingbalance(), DecimalAmt(0))
        for i, pk in enumerate(priv_keys[:NUM_OF_DELEGATIONS]):
            ...
            assert_equal(self.nodes[1].getlitenodestakingbalance(), DecimalAmt(10 * (i + 1)))
        ...
        for i, sa in enumerate(staking_addresses[NUM_OF_DELEGATIONS:]):
            ...
            assert_equal(self.nodes[1].getlitenodestakingbalance(), DecimalAmt(10 * NUM_OF_DELEGATIONS))
        self.log.info("Balance of node 1 checks out")
