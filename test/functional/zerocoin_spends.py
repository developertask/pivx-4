...
class ZerocoinSpendTest(OhonetworkTestFramework):
    ...
    def run_test(self):
        ...
        block_time = stake_4_blocks(block_time)
        self.check_tx_in_chain(0, txid)
        zoho_balance, balance = check_balances(denom_2, zoho_balance, balance)
        ...
        block_time = stake_4_blocks(block_time)
        self.check_tx_in_chain(0, txid)
        zoho_balance, balance = check_balances(denom_3, zoho_balance, balance)
        ...
        assert_raises_rpc_error(-26, "bad-txns-invalid-zoho",
        ...
        _, _ = check_balances(denom_1, zoho_balance, balance)
        self.log.info("--> VALID PUBLIC COIN SPEND (v3) PASSED")
