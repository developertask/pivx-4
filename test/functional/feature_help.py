...
"""Verify that starting ohonetwork with -h works as expected."""
import subprocess

from test_framework.test_framework import OhonetworkTestFramework
from test_framework.util import assert_equal

class HelpTest(OhonetworkTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ohonetwork with -h for help text")
        ...
        self.log.info("Start ohonetwork with -version for version information")
