Contributing to OHONETWORK Core
============================

The OHONETWORK Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ohonetwork-project/ohonetwork/blob/master/doc/translation_process.md)
...
The following applies to code changes to the OHONETWORK Core project, and is not to be
confused with overall OHONETWORK Network Protocol consensus changes.

Whether a pull request is merged into OHONETWORK Core rests with the project merge
...
Patches that change OHONETWORK consensus rules are considerably more involved than
...
Where a patchset proposes to change the OHONETWORK consensus, it must have been
...
The project leader is the release manager for each OHONETWORK Core release.
